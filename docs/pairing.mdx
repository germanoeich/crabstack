...
Use this when onboarding a new remote component (tool host, listener, subscriber, remote CLI).
...
crab pair subscriber wss://10.0.0.2:7443 discord-outbound
crab pair cli wss://10.0.0.3:7443 gin-laptop
```
