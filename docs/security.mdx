...
- `crab auth codex` stores credentials at `~/.crabstack/auth/codex.json` by default.
- `crab auth anthropic` stores credentials at `~/.crabstack/auth/anthropic.json` by default.
