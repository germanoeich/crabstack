...
Pinchy components exchange a canonical event envelope across ingress, gateway, and subscribers.
...
- Channel ingress: `channel.message.*`
...
- Scheduler/system: `cron.triggered`, `heartbeat.tick`
