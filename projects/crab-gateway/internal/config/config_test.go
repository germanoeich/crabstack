...
func TestFromEnv_Default(t *testing.T) {
	t.Setenv("CRAB_GATEWAY_HTTP_ADDR", "")
	t.Setenv("CRAB_GATEWAY_DB_DRIVER", "")
	t.Setenv("CRAB_GATEWAY_DB_DSN", "")
	t.Setenv("CRAB_GATEWAY_ID", "")
	t.Setenv("CRAB_GATEWAY_KEY_DIR", "")
	t.Setenv("CRAB_GATEWAY_ADMIN_SOCKET_PATH", "")
	t.Setenv("CRAB_GATEWAY_PAIR_TIMEOUT", "")
	t.Setenv("CRAB_GATEWAY_REQUIRE_MTLS_REMOTE", "")
	t.Setenv("CRAB_GATEWAY_ALLOW_INSECURE_LOOPBACK_PAIRING", "")
	t.Setenv("CRAB_GATEWAY_PAIR_MTLS_CA_FILE", "")
	t.Setenv("CRAB_GATEWAY_PAIR_MTLS_CERT_FILE", "")
	t.Setenv("CRAB_GATEWAY_PAIR_MTLS_KEY_FILE", "")
	cfg := FromEnv()
...
func TestFromEnv_Override(t *testing.T) {
	t.Setenv("CRAB_GATEWAY_HTTP_ADDR", "127.0.0.1:9999")
	t.Setenv("CRAB_GATEWAY_DB_DRIVER", "PoStGrEs")
	t.Setenv("CRAB_GATEWAY_DB_DSN", "postgres://localhost/crabstack")
	t.Setenv("CRAB_GATEWAY_ID", "gw_home")
	t.Setenv("CRAB_GATEWAY_KEY_DIR", "/tmp/crabstack-keys")
	t.Setenv("CRAB_GATEWAY_ADMIN_SOCKET_PATH", "/tmp/crabstack-admin.sock")
	t.Setenv("CRAB_GATEWAY_PAIR_TIMEOUT", "45s")
	t.Setenv("CRAB_GATEWAY_REQUIRE_MTLS_REMOTE", "false")
	t.Setenv("CRAB_GATEWAY_ALLOW_INSECURE_LOOPBACK_PAIRING", "false")
	t.Setenv("CRAB_GATEWAY_PAIR_MTLS_CA_FILE", "/tmp/ca.pem")
	t.Setenv("CRAB_GATEWAY_PAIR_MTLS_CERT_FILE", "/tmp/client.crt")
	t.Setenv("CRAB_GATEWAY_PAIR_MTLS_KEY_FILE", "/tmp/client.key")
	cfg := FromEnv()
